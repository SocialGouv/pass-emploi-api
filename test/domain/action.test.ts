...
describe('Action', () => {
  describe('Factory', () => {
    ...
    const nowJsPlus3Mois = uneDatetime.plus({ months: 3 }).toJSDate()
    ...
    describe('buildAction', () => {
      describe('Quand le statut est present', () => {
        describe('quand le conseiller est le créateur', () => {
          ...
          it('crée une action avec la dateEcheance fournie', async () => {
            // Given
            const contenu = 'test'
            const idJeune = '1'
            const commentaire = 'test'
        ...
        describe('quand le jeune est le créateur', () => {
          ...
          it('crée une action avec dateEcheance et rappel fournis', async () => {
            // Given
            const contenu = 'test'
            const idJeune = '1'
            const commentaire = 'test'
            const statut = Action.Statut.TERMINEE
            const typeCreateur = Action.TypeCreateur.JEUNE
            const dateEcheance = new Date('2020-02-22')
            const rappel = false
