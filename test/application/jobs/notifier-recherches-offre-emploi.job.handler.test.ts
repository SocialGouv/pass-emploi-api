...
import { NotifierRecherchesOffreEmploiJobHandler } from '../../../src/application/jobs/notifier-recherches-offre-emploi.job.handler'
...
describe('NotifierNouvellesOffresEmploiCommandHandler', () => {
  let notifierNouvellesOffresEmploiCommandHandler: NotifierRecherchesOffreEmploiJobHandler
  ...
  beforeEach(() => {
    ...
    notifierNouvellesOffresEmploiCommandHandler =
      new NotifierRecherchesOffreEmploiJobHandler(
        dateService,
        rechercheRepository,
