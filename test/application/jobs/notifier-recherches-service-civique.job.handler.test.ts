...
import { NotifierRecherchesServiceCiviqueJobHandler } from '../../../src/application/jobs/notifier-recherches-service-civique.job.handler'
...
describe('NotifierRecherchesServiceCiviqueJobHandler', () => {
  describe('handle', () => {
    ...
    let notifierRecherchesServiceCiviqueJobHandler: NotifierRecherchesServiceCiviqueJobHandler
    ...
    beforeEach(() => {
      ...
      notifierRecherchesServiceCiviqueJobHandler =
        new NotifierRecherchesServiceCiviqueJobHandler(
          rechercheRepository,
          jeuneRepository,
          notificationService,
          findAllOffresServicesCiviqueQueryGetter,
    ...
    describe("quand il n'y a pas de nouvelles offres depuis hier à 10 heures", () => {
      it('renvoie juste les stats', async () => {
        ...
        // When
        const result = await notifierRecherchesServiceCiviqueJobHandler.handle()
    ...
    describe('quand il y a une nouvelle offre depuis hier à 10 heures', () => {
      ...
      describe('quand aucune recherche ne correspond', () => {
        it('renvoie juste les stats', async () => {
          ...
          // When
          const result =
            await notifierRecherchesServiceCiviqueJobHandler.handle()
      ...
      describe('quand une recherche correspond', () => {
        ...
        beforeEach(async () => {
          ...
          // When
          result = await notifierRecherchesServiceCiviqueJobHandler.handle()
        })
