import { MajAgenceAnimationCollectiveJobHandler } from '../../../src/application/jobs/maj-agence-animation-collective.job.handler.db'
...
describe('HandleJobAgenceAnimationCollectiveCommand', () => {
  ...
  let command: MajAgenceAnimationCollectiveJobHandler
  ...
  beforeEach(async () => {
    ...
    command = new MajAgenceAnimationCollectiveJobHandler(
      database.sequelize,
      new DateService(),
