...
def test_to_sql_action_creator():
    # Given
    action_creator = ActionCreator('3', '2', ActionCreatorType.CONSEILLER)

    # When
    sql_action_creator = to_sql_action_creator(action_creator)

    # Then
    assert sql_action_creator.creatorId == '2'
    assert sql_action_creator.actionCreatorType == ActionCreatorType.CONSEILLER
