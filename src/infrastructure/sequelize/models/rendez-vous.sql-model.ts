...
export class RendezVousDtoOld extends Model {
  @PrimaryKey
...
export class RendezVousSqlModelOld extends RendezVousDtoOld {
...
export class RendezVousSqlModel extends RendezVousDto {
  @BelongsToMany(() => JeuneSqlModel, () => RendezVousJeuneAssociationModel)
