const ACTION_TEMPLATES = [
  ...
  { id: 'action-predefinie-6', titre: 'Participer à un salon / un forum' },
  { id: 'action-predefinie-7', titre: "S'informer sur une formation" },
  { id: 'action-predefinie-8', titre: 'Contacter un organisme de formation' },
  {
    id: 'action-predefinie-9',
    titre: 'Ouvrir son compte personnel de formation'
  },
  { id: 'action-predefinie-10', titre: 'Mettre à jour son CV' },
  { id: 'action-predefinie-11', titre: 'Rédiger une lettre de motivation' },
  { id: 'action-predefinie-12', titre: "Consulter les offres d'emploi" },
  { id: 'action-predefinie-13', titre: "Répondre à une offre d'emploi" },
  {
    id: 'action-predefinie-14',
    titre: 'Effectuer des candidatures spontanées'
  },
  { id: 'action-predefinie-15', titre: 'Tenir un tableau de prospection' },
  {
  ...
  },
  {
    ...
    titre: 'Rechercher des informations pour créer ou reprendre une entreprise'
  },
  { id: 'action-predefinie-18', titre: 'Contacter la mission locale' },
  {
    id: 'action-predefinie-19',
    titre: 'Contacter un organisme de prestations sociales (ex CAF, CPAM, MSA)'
  },
  {
