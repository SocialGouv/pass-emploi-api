...
export const listeCronJobs: Planificateur.CronJob[] = [
  ...
  },
  {
    ...
    expression: '0 4 * * *',
    description:
      'Tous les jours à 4h. Supprime les jobs de rappels concernant des rdv/actions supprimées'
  },
  {
    type: Planificateur.JobType.NETTOYER_LES_DONNEES,
    expression: '0 5 * * *',
    description:
      "Tous les jours à 5h. Supprime entre autres les évenements d'engagement hebdo de plus d'une semaine"
  },
  {
