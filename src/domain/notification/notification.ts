...
export namespace Notification {
  ...
  export enum TypeNotifManuelle {
    ...
    BENEVOLAT = Type.BENEVOLAT,
    CAMPAGNE = Type.CAMPAGNE,
    EVENT_LIST = Type.EVENT_LIST,
    LA_BONNE_ALTERNANCE = Type.LA_BONNE_ALTERNANCE,
    MON_SUIVI = Type.MON_SUIVI,
    NOUVELLES_FONCTIONNALITES = Type.NOUVELLES_FONCTIONNALITES,
    OFFRES_ENREGISTREES = Type.OFFRES_ENREGISTREES,
    OUTILS = Type.OUTILS,
