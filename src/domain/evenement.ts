...
export namespace Evenement {
  export enum Code {
    ...
    ACTION_CREEE_IA_REFERENTIEL = 'ACTION_CREEE_IA_REFERENTIEL',
    ACTION_CREEE_IA_HORS_REFERENTIEL = 'ACTION_CREEE_IA_HORS_REFERENTIEL',
    ...
    RECHERCHE_MESSAGE = 'RECHERCHE_MESSAGE',
